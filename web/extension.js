...
const WANVIDEO_NODE_TYPE = "WanVideoWakawaveLoraLoader";
const superLoraExtension = {
  ...
  beforeRegisterNodeDef(nodeType, nodeData) {
    if (nodeData.name === NODE_TYPE || nodeData.name === WANVIDEO_NODE_TYPE) {
   ...
   */
  nodeCreated(node) {
    if (node.type === NODE_TYPE || node.type === WANVIDEO_NODE_TYPE) {
